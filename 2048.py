...
Játékszabályok:
Random helyre két szám. 2 db 2, vagy egy kettes, és egy négyes
A felbukkanó számok sosem nagyobbak négynél, kivéve ízi mód.
A felbukkanó számok az üres helyekre, random spawnolnak. Ugyanazon számok összeadódnak.
...
Features:
- Választható méretű min: 4x4 max 16x16
- színek
- választható nehézségi szint 

Funkciók
	-mező generálás
	-mozgatás
	-faltól falig
	-ha azonosak találkoznak duplázás - score fel
- spawnolás
	-nyitáskor az üres helyekre sorsol be 2 db 2est és/vagy 4est
	-utána egy darab kettest vagy négyest
- pontozás: Ha összeadódik két szám az összeadott értékkel nő a pont


MOVE
	ha lenyomom a wasd valamelyikét, a mátrix nem nulla értékai elmozdulnak a mátrix szélső pozícióiba
	w - fel
	s - le
	a - balra
	d - jobbra
	végignézi a sort. ha az utolsó helyen nulla van, az utolsó nem nullát beteszi a helyére, majd az utolsó előtti nem nullát az utolsó előtti helyére, stb.
